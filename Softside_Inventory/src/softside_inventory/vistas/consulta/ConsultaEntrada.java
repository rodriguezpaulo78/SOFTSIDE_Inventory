package softside_inventory.vistas.consulta;

import softside_inventory.controladores.consulta.IEntrada;

/**
 * Vista principal de Consulta de Entrada de Productos
 * @author SOFTSIDE
 */
public class ConsultaEntrada extends javax.swing.JFrame
{
    private IEntrada interfaz;
    
    public ConsultaEntrada(IEntrada interfaz)
    {
        initComponents();
        ...
        interfaz.cargar(txtProCod, cbxProNom);
    }
    ...
    private void initComponents() {
        ...
        btnVolver.setIcon(new javax.swing.ImageIcon(getClass().getResource("/softside_inventory/recursos/menu.png"))); // NOI18N
