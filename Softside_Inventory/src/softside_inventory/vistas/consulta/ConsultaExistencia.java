...
import softside_inventory.controladores.consulta.IExistencia;

/**
 * Vista principal de Consulta de Existencia de Productos
 * @author SOFTSIDE
 */
public class ConsultaExistencia extends javax.swing.JFrame
{
    private IExistencia interfaz;
    
    public ConsultaExistencia(IExistencia interfaz)
    {
        initComponents();
