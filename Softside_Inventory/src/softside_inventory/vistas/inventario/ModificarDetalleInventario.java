...
import softside_inventory.controladores.inventario.IModificarDetalleInventario;

/**
 * Vista principal de Modificar Inventario Detalle
 * @author SOFTSIDE
 */
public class ModificarDetalleInventario extends javax.swing.JFrame
{
    private IModificarDetalleInventario interfaz;

    public ModificarDetalleInventario(IModificarDetalleInventario interfaz)
    {
        initComponents();
        this.setVisible(true);
        this.setTitle("Modificar Inventario Detalle");
    ...
    private void initComponents() {
        ...
        lblTitulo2.setText("MODIFICAR DETALLE");
