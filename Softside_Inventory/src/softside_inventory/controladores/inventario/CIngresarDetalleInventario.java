...
public class CIngresarDetalleInventario implements IRegistrarDetalleInventario
{
    ...
    public CIngresarDetalleInventario(String codigoProducto, String codigoAlmacen, String cantidad, String valTot)
    {
