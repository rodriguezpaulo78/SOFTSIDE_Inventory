...
public interface IModificarDetalleInventario
{
    ...
    public void cargar(JTextField txtDoc, JTextField txtInvDetCod, JTextField txtProCod, JDateChooser fecha, JComboBox cbxOpe, JTextField txtCan, JTextField txtValUni, JTextField txtValTot, JTextArea txtObs);
